# This file contains the code for the construction of plot3
# The plot has been constructed in png file and saved as png3.png
...
# opening a png file
png(filename = "png3.png",width = 480,height = 480,units = "px")
