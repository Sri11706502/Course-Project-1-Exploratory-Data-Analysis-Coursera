# This file contains the code for the construction of plot2
# The plot has been constructed in png file and saved as png2.png
...
# Opening a png file
png(filename = "png2.png",width = 480,height = 480,units = "px")
